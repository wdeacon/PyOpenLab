...
import cv2
import numpy as np
from pyopenlab.utils.notified_property import DumbNotifiedProperty, NotifiedProperty, register_for_property_changes
...
class Image_Filter_box(Instrument):
    ...
    def __init__(self,threshold = 40, bin_fac = 4,min_size = 2,max_size = 6,
                 bilat_size = 3, bilat_height = 40, morph_kernel_size = 3,area_size = 100,grid_pitch = 10):
        ...
        self.filter_options = ['None','STBOC_with_size_filter','strided_rescale','StrBiThresOpen','Grid']
    ...
    def Grid(self,g,
        ...
        return Grid(g, 
                    ...
                    L = self.area_size,
                    show_particles=False,return_centers=False,
                    return_original_with_particles = False,
                    return_centers_and_radii=False)
