...
class GuiGenerator(QtWidgets.QMainWindow, UiTools):
    ...
    def menuTerminal(self):
        ...
        """
        from pyopenlab.utils import terminal
        if self.terminalWindow is None:
            if os.environ["QT_API"] == "pyqt5":
                ...
                self.terminalWindow.execute_command('import pyopenlab.datafile as df')
                ...
                self.terminalWindow.execute('import pyopenlab.datafile as df')
