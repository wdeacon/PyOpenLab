...
def send_email(to_address, message, subject="[pyopenlab] Notification", raise_exceptions=False):
    ...
    try:
        header = "From: {0}\r\nTo: {1}\r\nSubject: {2}\r\n\r\n".format(
            NPLAB_FROM_ADDRESS, to_address, subject)
...
if __name__ == "__main__":
    ...
    #send_email("rwb27@cam.ac.uk", "Test email from pyopenlab, sent at {0}".format(datetime.datetime.now().isoformat()))
