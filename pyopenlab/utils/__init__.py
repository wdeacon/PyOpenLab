...
def monitor_property(instance, property_name, how_long, how_often, warn_limits=None):
    """
    Given an pyopenlab instrument instance and one of it's properties, it creates a deque containing the property's value
    over time. The deque gets updated in a background thread.

    :param instance: pyopenlab.Instrument
