...
for instruments, experiments, etc. It's deliberately not in pyopenlab.ui
...
class ShowGUIMixin():
    ...
    def show_gui(self, blocking=None, block=None, force_new_window=False, dark=False):
        ...
        if hasattr(self,'get_qt_ui'):
            ...
            # pyopenlab with dependencies on Qt.
            from pyopenlab.utils.gui import QtCore, QtGui, QtWidgets, get_qt_app
            app = get_qt_app()
