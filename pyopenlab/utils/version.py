...
def git_folder():
    """Find the git folder for the repo that contains pyopenlab."""
    project_dir = os.path.dirname(os.path.dirname(pyopenlab.__file__))
...
def version_info_string():
    ...
    version_string = "pyopenlab %s\n" % pyopenlab.__version__
    try:
