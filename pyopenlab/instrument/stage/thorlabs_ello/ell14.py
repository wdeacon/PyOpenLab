# -*- coding: utf-8 -*-
"""Driver and Qt UI for the Thorlabs ELL14 rotation mount."""
import sys
...
class Ell14(ElloDevice):
    ...
    def get_position(self, axis=None):
        """Query the mount and return its current angle in degrees.
    ...
    def move_absolute(self, angle, blocking=True):
        ...
        The mount only accepts non-negative angles, so out-of-range and negative inputs
    ...
    def get_qt_ui(self):
        """Return the Qt control widget for this mount."""
        return Thorlabs_ELL14_UI(self)


class Thorlabs_ELL14_UI(QtWidgets.QWidget, UiTools):
    """Qt widget for driving an ELL14 mount (relative/absolute/home moves)."""
...
def test_ui():
    """Launch the mount UI against a stage on COM1; for manual testing."""
    s = Ell14("COM1")
    app = get_qt_app()
