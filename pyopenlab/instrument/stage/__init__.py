...
#
#    Subclassing pyopenlab.stage.Stage
#    -----------------------------
...
#                raise NotImplementedError("pyopenlab.stage.Stage was instructed to emulate blocking moves, but wait_until_stopped returned an error.  Perhaps this is because is_moving has not been subclassed? The original error was "+e.message)
