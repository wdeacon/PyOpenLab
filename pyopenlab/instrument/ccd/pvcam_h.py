...
def ML32_BYTE(four_byte_val):
    return ((uns8)((four_byte_val) >> 8))  # macro
...
def LS32_BYTE(four_byte_val):
    return ((uns8)(four_byte_val))  # macro


def MS16_BYTE(two_byte_value):
    return ((uns8)((two_byte_value) >> 8))  # macro
...
def LS16_BYTE(two_byte_value):
    return ((uns8)(two_byte_value))  # macro
...
def VAL_UNS16(ms_byte, ls_byte):
    return ((uns16)(((uns16)((uns8)(ms_byte)) << 8) | ((uns16)((uns8)(ls_byte)))))  # macro


def VAL_UNS32(ms_byte, mh_byte, ml_byte, ls_byte):
    return (((uns32)((uns8)(ms_byte)) << 24) | ((uns32)((uns8)(mh_byte)) << 16) | ((uns32)(
        (uns8)(ml_byte)) << 8) | ((uns32)((uns8)(ls_byte))))  # macro


def MS32_BYTE(four_byte_val):
    return ((uns8)((four_byte_val) >> 24))  # macro
...
def MH32_BYTE(four_byte_val):
    return ((uns8)((four_byte_val) >> 16))  # macro
...
__all__ = [
    'READOUT_COMPLETE', 'IO_DIR_INPUT_OUTPUT', 'PARAM_SHTR_OPEN_DELAY', 'ATTR_ACCESS', 'CLASS32',
    'CAM_NAME_LEN', 'CLASS30', 'CLASS31', 'PARAM_SUMMING_WELL', 'OUTPUT_IMAGE_SHIFT',
    'PARAM_COOLING_FAN_CTRL', 'PARAM_EXP_MIN_TIME', 'PARAM_KIN_WIN_SIZE', 'PBC_DISABLED', 'TU_HOUR',
    'TYPE_BOOLEAN', 'EXP_RES_ONE_MICROSEC', 'PARAM_PMODE', 'MAX_CAM', 'STROBED_MODE', 'uns8_ptr',
    'SCR_POST_FLASH', 'PARAM_PAR_SHIFT_INDEX', 'ATTR_DEFAULT', 'rs_bool_ptr', 'END_FRAME_IRQS',
    'TYPE_ENUM', 'VARIABLE_TIMED_MODE', 'ATTR_MIN', 'PARAM_LOGIC_OUTPUT_INVERT',
    'CCS_HALT_CLOSE_SHTR', 'ANTIBLOOM_ACTIVE', 'CCS_CLEAR', 'PARAM_SHTR_RES',
    'HEAD_COOLING_CTRL_NA', 'ACC_READ_WRITE', 'OPTN_BD_FOR_SPR', 'IO_DIR_OUTPUT',
    'SHTR_RES_1_MILLI_SEC', 'PARAM_READOUT_PORT', 'PRECISION_UNS16', 'PARAM_EXPOSURE_MODE',
    'TU_USEC', 'SCR_POST_OPEN_SHTR', 'boolean', 'CLASS6', 'CLASS4', 'PARAM_SERIAL_NUM', 'CLASS2',
    'CLASS3', 'CLASS0', 'CLASS1', 'PARAM_ACCUM_CAPABLE', 'rs_bool', 'PARAM_POSTMASK',
    'INTENSIFIER_SAFE', 'export_ctrl_type', 'PRECISION_INT16', 'PARAM_PAR_SIZE',
    'PARAM_PIX_PAR_SIZE', 'TYPE_UNS32', 'PARAM_COOLING_MODE', 'CLASS96', 'CLASS97', 'CLASS90',
    'CLASS91', 'CLASS92', 'CLASS93', 'PARAM_DD_VERSION', 'CLASS98', 'CLASS99',
    'PARAM_CONTROLLER_ALIVE', 'PARAM_CHIP_NAME', 'BIG_ENDIAN', 'PARAM_CUSTOM_CHIP',
    'PMODE_INTERLINE', 'PMODE_DIF', 'OUTPUT_NOT_RDY', 'CCS_CLEAR_CLOSE_SHTR', 'TYPE_INT16',
    'READOUT_FAILED', 'PMODE_ALT_NORMAL', 'CIRC_OVERWRITE', 'COOLING_FAN_CTRL_ON',
    'READOUT_NOT_ACTIVE', 'NO_FRAME_IRQS', 'SHTR_CLOSING', 'ANTIBLOOM_NOTUSED', 'ATTR_COUNT',
    'LS32_BYTE', 'READOUT_PORT_MULT_GAIN', 'PARAM_PIX_PAR_DIST', 'IO_TYPE_DAC', 'OPTN_BD_SPEC',
    'uns16', 'boolean_const_ptr', 'int16', 'PARAM_PIX_SER_DIST', 'MH32_BYTE', 'OPEN_PRE_SEQUENCE',
    'ACC_EXIST_CHECK_ONLY', 'OPEN_NO_CHANGE', 'CCS_OPEN_SHTR', 'TYPE_CHAR_PTR', 'uns32_const_ptr',
    'PV_FAIL', 'INTENSIFIER_GATING', 'PARAM_CCS_STATUS', 'TU_MSEC', 'READOUT_PORT_NORMAL',
    'void_ptr', 'SCR_POST_READOUT', 'SCR_POST_INTEGRATE', 'OUTPUT_READOUT', 'VAL_UNS16',
    'PARAM_BOF_EOF_ENABLE', 'PARAM_BOF_EOF_COUNT', 'SHTR_OPENING', 'PARAM_NUM_MIN_BLOCK',
    'PARAM_GAIN_MULT_FACTOR', 'SCR_PRE_READOUT', 'uns32_ptr', '_master_h_', 'FRAME_AVAILABLE',
    'PARAM_DD_INFO', 'CLEAR_PRE_EXPOSURE', 'int32_const_ptr', 'ML32_BYTE', 'PMODE_FT_MPP',
    'PMODE_MPP', 'PARAM_ADC_OFFSET', 'CCS_HALT', 'PARAM_DIAG', 'PARAM_BIT_DEPTH', 'CLEAR_NEVER',
    'OPEN_EXCLUSIVE', 'ATTR_MAX', 'rgn_ptr', 'PARAM_SKIP_AT_ONCE_BLK', 'flt64', 'char_ptr',
    'SHTR_UNKNOWN', 'rgn_type', 'PARAM_HW_AUTOSTOP32', 'MAX_ALPHA_SER_NUM_LEN', 'PARAM_CAMERA_TYPE',
    'OUTPUT_LOGIC1', 'OUTPUT_LOGIC0', 'PARAM_MIN_BLOCK', 'OUTPUT_WAIT_FOR_TRIG', 'PARAM_PBC',
    'COOLING_FAN_CTRL_OFF', 'ATTR_INCREMENT', 'CLEAR_PRE_SEQUENCE', 'ACC_ERROR',
    'PARAM_SHTR_STATUS', 'OPEN_NEVER', 'OUTPUT_SHUTTER', 'TYPE_VOID_PTR', 'READOUT_IN_PROGRESS',
    'BEGIN_FRAME_IRQS', 'EDGE_TRIG_POS', 'PARAM_EDGE_TRIGGER', 'COLOR_NONE', 'int32_ptr',
    'OPTN_BD_SS_FAST_GATE', 'PARAM_INTENSIFIER_GAIN', 'PARAM_HEAD_SER_NUM_ALPHA',
    'PARAM_GAIN_MULT_ENABLE', 'FALSE', 'PARAM_PREMASK', 'CIRC_NO_OVERWRITE', 'SCR_PRE_FLASH',
    'SCR_PRE_INTEGRATE', 'TRIGGER_FIRST_MODE', 'HEAD_COOLING_CTRL_OFF', 'PARAM_LOGIC_OUTPUT',
    'uns16_const_ptr', 'PBC_ENABLED', 'PARAM_ANTI_BLOOMING', 'OPTN_BD_SPR_3917', 'PARAM_IO_STATE',
    'PARAM_IO_TYPE', 'SHTR_RES_100_NANO_SEC', 'PARAM_PREEXP_CLEANS', 'PARAM_PCI_FW_VERSION',
    'PARAM_POSTSCAN', 'PARAM_IO_DIRECTION', 'EVENT_END_READOUT', 'SHTR_FAULT', 'PARAM_IO_BITDEPTH',
    'ATTR_AVAIL', 'PARAM_SKIP_SREG_CLEAN', 'IO_TYPE_TTL', 'ACQUISITION_IN_PROGRESS', 'uns16_ptr',
    'MS32_BYTE', 'PARAM_PIX_SER_SIZE', 'OUTPUT_CLEARING', 'READOUT_PORT_HIGH_CAP', 'boolean_ptr',
    'PARAM_SPDTAB_INDEX', 'rgn_const_ptr', 'char_const_ptr', 'MAX_CAMERA_STATUS', 'PRECISION_UNS32',
    'ACC_READ_ONLY', 'PARAM_CAM_FW_FULL_VERSION', 'int16_ptr', 'PARAM_SHTR_OPEN_MODE',
    'BEGIN_END_FRAME_IRQS', 'TU_PSEC', 'OPTN_BD_NONE', 'SHTR_OPEN', 'export_ctrl_ptr',
    'PARAM_DD_RETRIES', 'CCS_CLEAR_OPEN_SHTR', 'COLOR_RGGB', 'PARAM_IO_ADDR', 'TRUE',
    'PARAM_SHTR_CLOSE_DELAY', 'ANTIBLOOM_INACTIVE', 'PARAM_BOF_EOF_CLR', 'flt64_const_ptr',
    'PARAM_DD_INFO_LENGTH', 'TYPE_UNS64', 'ERROR_MSG_LEN', 'TYPE_INT32', 'FLASH_MODE',
    'OPEN_PRE_TRIGGER', 'TYPE_VOID_PTR_PTR', 'uns8_const_ptr', 'OUTPUT_ACQUIRING',
    'PRECISION_INT32', 'OUTPUT_NOT_SCAN', 'SHTR_RES_100_MICRO_SEC', 'PARAM_NUM_OF_STRIPS_PER_CLR',
    'IO_ATTR_DIR_VARIABLE_ALWAYS_READ', 'PARAM_DIAG_P5', 'PARAM_DIAG_P4', 'PARAM_DIAG_P3',
    'PARAM_DIAG_P2', 'PARAM_DIAG_P1', 'TYPE_INT8', 'OPTN_BD_PTG_FAST_GATE', 'PARAM_SER_SHIFT_TIME',
    'PARAM_SER_SIZE', 'TIME_UNITS', 'OUTPUT_NOT_FT_IMAGE_SHIFT', 'CIRC_NONE', 'INTENSIFIER_SHUTTER',
    'PARAM_CONT_CLEARS', 'PARAM_CUSTOM_TIMING', 'PARAM_HEAD_COOLING_CTRL', 'TU_MINUTE', 'CRYO_COOL',
    'IO_DIR_INPUT', 'CCD_NAME_LEN', 'int16_const_ptr', 'PARAM_CIRC_BUFFER', 'MPP_SELECTABLE',
    'PARAM_COLOR_MODE', 'TYPE_UNS16', '_pvcam_h_', 'PARAM_CLN_WHILE_EXPO', 'MPP_UNKNOWN',
    'int8_ptr', 'PV_OK', 'PARAM_HW_AUTOSTOP', 'CLEAR_POST_SEQUENCE', 'flt64_ptr', 'MPP_ALWAYS_ON',
    'export_ctrl_const_ptr', 'ACC_WRITE_ONLY', 'CLASS29', 'PARAM_TEMP_SETPOINT', 'TU_DAY',
    'PARAM_PIX_TIME', 'LS16_BYTE', 'PARAM_PREAMP_OFF_CONTROL', 'HEAD_COOLING_CTRL_ON', 'TU_FSEC',
    'PARAM_SHTR_CLOSE_DELAY_UNIT', 'OPTN_BD_SS_RF_MOD', 'PARAM_CAM_FW_VERSION', 'PARAM_PREFLASH',
    'PARAM_CLEAR_MODE', 'BULB_MODE', 'ATTR_TYPE', 'int32', 'uns32', 'OUTPUT_RESERVED',
    'PARAM_EXP_RES', 'PARAM_FWELL_CAPACITY', 'PARAM_FTSCAN', 'PARAM_READOUT_TIME', 'int8_const_ptr',
    'void_ptr_ptr', 'SCR_PRE_OPEN_SHTR', 'SHTR_CLOSED', 'uns8', 'OPEN_PRE_EXPOSURE', 'CLASS5',
    'PRECISION_UNS8', 'TYPE_FLT64', 'SCR_PRE_CLOSE_SHTR', 'PARAM_EXP_TIME', 'OUTPUT_EXPOSE',
    'PARAM_SHTR_GATE_MODE', 'EDGE_TRIG_NEG', 'TIMED_MODE', 'PRECISION_INT8', 'TYPE_UNS8',
    'EXPOSURE_IN_PROGRESS', 'PARAM_MPP_CAPABLE', 'PARAM_PRESCAN', 'OPTN_BD_END', 'PARAM_DD_TIMEOUT',
    'INT_STROBE_MODE', 'SCR_POST_CLOSE_SHTR', 'PMODE_ALT_MPP', 'CLEAR_PRE_POST_SEQUENCE',
    'OUTPUT_EXPOSE_PROG', 'READOUT_PORT_LOW_NOISE', 'TU_SEC', 'EXP_RES_ONE_MILLISEC',
    'EXP_RES_ONE_SEC', 'EVENT_START_READOUT', 'PARAM_PAR_SHIFT_TIME', 'MPP_ALWAYS_OFF', 'int8',
    'PMODE_FT', 'VAL_UNS32', 'PMODE_NORMAL', 'MS16_BYTE', 'PARAM_TEMP', 'PARAM_CLEAR_CYCLES',
    'CLASS94', 'CLASS95', 'PARAM_EXP_RES_INDEX', 'PMODE_ALT_FT_MPP', 'PMODE_ALT_FT',
    'PARAM_TG_OPTION_BD_TYPE', 'PARAM_GAIN_INDEX', 'CLEAR_PRE_EXPOSURE_POST_SEQ', 'NORMAL_COOL',
    'ATTR_CURRENT', 'IO_ATTR_DIR_FIXED', 'COOLING_FAN_CTRL_NA', 'TU_NSEC', 'CCS_NO_CHANGE',
    'PMODE_SPECTRA_KINETICS', 'rs_bool_const_ptr', 'PMODE_KINETICS', 'PARAM_PREAMP_DELAY',
    'READOUT_PORT2', 'READOUT_PORT1', 'PARAM_FRAME_CAPABLE']
