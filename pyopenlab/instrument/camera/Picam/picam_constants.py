...
PicamParameter = {
    ...
    "PicamParameter_ModulationOutputSignalFrequency":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Range', 117),
    "PicamParameter_Accumulations":
        ('PicamValueType_LargeInteger', 'PicamConstraintType_Range', 92),
    "PicamParameter_SensorActiveLeftMargin":
        ('PicamValueType_Integer', 'PicamConstraintType_None', 61),
    "PicamParameter_ExternalShutterType":
        ('PicamValueType_Enumeration', 'PicamConstraintType_None', 152),
    "PicamParameter_CustomModulationSequence":
        ('PicamValueType_Modulations', 'PicamConstraintType_Modulations', 119),
    "PicamParameter_CleanUntilTrigger":
        ('PicamValueType_Boolean', 'PicamConstraintType_Collection', 22),
    "PicamParameter_PhotocathodeSensitivity":
        ('PicamValueType_Enumeration', 'PicamConstraintType_None', 107),
    "PicamParameter_ShutterClosingDelay":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Range', 25),
    "PicamParameter_InternalShutterStatus":
        ('PicamValueType_Enumeration', 'PicamConstraintType_None', 153),
    "PicamParameter_EnableAuxOutput":
        ('PicamValueType_Boolean', 'PicamConstraintType_Collection', 161),
    "PicamParameter_KineticsWindowHeight":
        ('PicamValueType_Integer', 'PicamConstraintType_Range', 56),
    "PicamParameter_DelayFromPreTrigger":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Range', 132),
    "PicamParameter_GatingSpeed": ('PicamValueType_Enumeration', 'PicamConstraintType_None', 108),
    "PicamParameter_ExternalShutterStatus":
        ('PicamValueType_Enumeration', 'PicamConstraintType_None', 154),
    "PicamParameter_SensorSecondaryActiveHeight":
        ('PicamValueType_Integer', 'PicamConstraintType_None', 74),
    "PicamParameter_ExactReadoutCountMaximum":
        ('PicamValueType_LargeInteger', 'PicamConstraintType_None', 77),
    "PicamParameter_AdcSpeed":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Collection', 33),
    ...
    "PicamParameter_SensorActiveRightMargin":
        ('PicamValueType_Integer', 'PicamConstraintType_None', 63),
    "PicamParameter_CorrectPixelBias":
        ('PicamValueType_Boolean', 'PicamConstraintType_Collection', 106),
    "PicamParameter_CenterWavelengthReading":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_None', 141),
    "PicamParameter_CleanBeforeExposure":
        ('PicamValueType_Boolean', 'PicamConstraintType_Collection', 78),
    "PicamParameter_TriggerSource":
        ('PicamValueType_Enumeration', 'PicamConstraintType_Collection', 79),
    "PicamParameter_OutputSignal2":
        ('PicamValueType_Enumeration', 'PicamConstraintType_Collection', 150),
    "PicamParameter_SensorActiveTopMargin":
        ('PicamValueType_Integer', 'PicamConstraintType_None', 62),
    "PicamParameter_InactiveShutterTimingModeResult":
        ('PicamValueType_Enumeration', 'PicamConstraintType_None', 156),
    ...
    "PicamParameter_ShutterDelayResolution":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Collection', 47),
    ...
    "PicamParameter_EnableModulation":
        ('PicamValueType_Boolean', 'PicamConstraintType_Collection', 111),
    "PicamParameter_Rois,": ('PicamValueType_Rois', 'PicamConstraintType_Rois', 37),
    "PicamParameter_CleanSerialRegister":
        ('PicamValueType_Boolean', 'PicamConstraintType_Collection', 19),
    "PicamParameter_NondestructiveReadoutPeriod":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Range', 129),
    "PicamParameter_EnableNondestructiveReadout":
        ('PicamValueType_Boolean', 'PicamConstraintType_Collection', 128),
    "PicamParameter_TriggerDelay":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Range', 164),
    "PicamParameter_ReadoutTimeCalculation":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_None', 27),
    "PicamParameter_TriggerFrequency":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Range', 80),
    "PicamParameter_ShutterTimingMode":
        ('PicamValueType_Enumeration', 'PicamConstraintType_Collection', 24),
    "PicamParameter_IntensifierStatus":
        ('PicamValueType_Enumeration', 'PicamConstraintType_None', 87),
    "PicamParameter_InvertOutputSignal":
        ('PicamValueType_Boolean', 'PicamConstraintType_Collection', 52),
    "PicamParameter_OnlineReadoutRateCalculation":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_None', 99),
    "PicamParameter_SecondaryActiveHeight":
        ('PicamValueType_Integer', 'PicamConstraintType_Range', 76),
    "PicamParameter_SensorSecondaryMaskedHeight":
        ('PicamValueType_Integer', 'PicamConstraintType_None', 49),
    "PicamParameter_LightSourceStatus":
        ('PicamValueType_Enumeration', 'PicamConstraintType_None', 134),
    "PicamParameter_SensorMaskedBottomMargin":
        ('PicamValueType_Integer', 'PicamConstraintType_None', 67),
    "PicamParameter_ModulationOutputSignalAmplitude":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Range', 120),
    "PicamParameter_DisableDataFormatting":
        ('PicamValueType_Boolean', 'PicamConstraintType_Collection', 55),
    "PicamParameter_SecondaryMaskedHeight":
        ('PicamValueType_Integer', 'PicamConstraintType_Range', 75),
    "PicamParameter_PixelBitDepth": ('PicamValueType_Integer', 'PicamConstraintType_None', 48),
    "PicamParameter_ReadoutControlMode":
        ('PicamValueType_Enumeration', 'PicamConstraintType_Collection', 26),
    "PicamParameter_SensorMaskedTopMargin":
        ('PicamValueType_Integer', 'PicamConstraintType_None', 66),
    "PicamParameter_SensorTemperatureStatus":
        ('PicamValueType_Enumeration', 'PicamConstraintType_None', 16),
    "PicamParameter_DifStartingGate": ('PicamValueType_Pulse', 'PicamConstraintType_Pulse', 102),
    "PicamParameter_ExposureTime":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Range', 23),
    ...
    "PicamParameter_CleanSectionFinalHeight":
        ('PicamValueType_Integer', 'PicamConstraintType_Range', 17),
    "PicamParameter_StopCleaningOnPreTrigger":
        ('PicamValueType_Boolean', 'PicamConstraintType_Collection', 130),
    "PicamParameter_DifEndingGate": ('PicamValueType_Pulse', 'PicamConstraintType_Pulse', 103),
    "PicamParameter_MaskedBottomMargin":
        ('PicamValueType_Integer', 'PicamConstraintType_Range', 73),
    "PicamParameter_CleanSectionFinalHeightCount":
        ('PicamValueType_Integer', 'PicamConstraintType_Range', 18),
    "PicamParameter_SensorActiveBottomMargin":
        ('PicamValueType_Integer', 'PicamConstraintType_None', 64),
    "PicamParameter_LifeExpectancy":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_None', 136),
    "PicamParameter_ActiveExtendedHeight":
        ('PicamValueType_Integer', 'PicamConstraintType_Range', 160),
    "PicamParameter_TimeStampResolution":
        ('PicamValueType_LargeInteger', 'PicamConstraintType_Collection', 69),
    "PicamParameter_TimeStampBitDepth":
        ('PicamValueType_Integer', 'PicamConstraintType_Collection', 70),
    "PicamParameter_GratingGrooveDensity":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_None', 144),
    "PicamParameter_GateTrackingBitDepth":
        ('PicamValueType_Integer', 'PicamConstraintType_Collection', 105),
    "PicamParameter_AdcBitDepth": ('PicamValueType_Integer', 'PicamConstraintType_Collection', 34),
    "PicamParameter_ReadoutPortCount":
        ('PicamValueType_Integer', 'PicamConstraintType_Collection', 28),
    "PicamParameter_LaserPower": ('PicamValueType_FloatingPoint', 'PicamConstraintType_Range', 138),
    "PicamParameter_TriggerResponse":
        ('PicamValueType_Enumeration', 'PicamConstraintType_Collection', 30),
    ...
    "PicamParameter_TriggerDetermination":
        ('PicamValueType_Enumeration', 'PicamConstraintType_Collection', 31),
    "PicamParameter_ShutterOpeningDelay":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Range', 46),
    "PicamParameter_EMIccdGainControlMode":
        ('PicamValueType_Enumeration', 'PicamConstraintType_Collection', 123),
    "PicamParameter_EnableSyncMaster":
        ('PicamValueType_Boolean', 'PicamConstraintType_Collection', 84),
    ...
    "PicamParameter_PhosphorDecayDelayResolution":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Collection', 90),
    "PicamParameter_SensorActiveExtendedHeight":
        ('PicamValueType_Integer', 'PicamConstraintType_None', 159),
    "PicamParameter_AnticipateTrigger":
        ('PicamValueType_Boolean', 'PicamConstraintType_Collection', 131),
    ...
    "PicamParameter_EnableModulationOutputSignal":
        ('PicamValueType_Boolean', 'PicamConstraintType_Collection', 116),
    ...
    "PicamParameter_CenterWavelengthSetPoint":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Range', 140),
    "PicamParameter_FrameTrackingBitDepth":
        ('PicamValueType_Integer', 'PicamConstraintType_Collection', 72),
    "PicamParameter_CoolingFanStatus":
        ('PicamValueType_Enumeration', 'PicamConstraintType_None', 162),
    "PicamParameter_VerticalShiftRate":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Collection', 13),
    "PicamParameter_SensorTemperatureReading":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_None', 15),
    "PicamParameter_SequentialStartingGate":
        ('PicamValueType_Pulse', 'PicamConstraintType_Pulse', 95),
    "PicamParameter_SensorTemperatureSetPoint":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Range', 14),
    "PicamParameter_FrameRateCalculation":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_None', 51),
    "PicamParameter_PixelFormat":
        ('PicamValueType_Enumeration', 'PicamConstraintType_Collection', 41),
    "PicamParameter_ModulationFrequency":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Range', 112),
    "PicamParameter_ReadoutOrientation":
        ('PicamValueType_Enumeration', 'PicamConstraintType_None', 54),
    "PicamParameter_ReadoutRateCalculation":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_None', 50),
    "PicamParameter_FramesPerReadout": ('PicamValueType_Integer', 'PicamConstraintType_None', 44),
    "PicamParameter_GatingMode":
        ('PicamValueType_Enumeration', 'PicamConstraintType_Collection', 93),
    "PicamParameter_GratingType": ('PicamValueType_Enumeration', 'PicamConstraintType_None', 142),
    "PicamParameter_PixelGapHeight":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_None', 12),
    "PicamParameter_ReadoutStride": ('PicamValueType_Integer', 'PicamConstraintType_None', 45),
    "PicamParameter_SequentialGateStepCount":
        ('PicamValueType_LargeInteger', 'PicamConstraintType_Range', 97),
    "PicamParameter_SeNsRWindowHeight":
        ('PicamValueType_Integer', 'PicamConstraintType_Range', 163),
    "PicamParameter_FocalLength": ('PicamValueType_FloatingPoint', 'PicamConstraintType_None', 146),
    "PicamParameter_PixelGapWidth":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_None', 11),
    "PicamParameter_InternalShutterType":
        ('PicamValueType_Enumeration', 'PicamConstraintType_None', 139),
    "PicamParameter_SensorType": ('PicamValueType_Enumeration', 'PicamConstraintType_None', 57),
    "PicamParameter_EnableIntensifier":
        ('PicamValueType_Boolean', 'PicamConstraintType_Collection', 86),
    ...
    "PicamParameter_CcdCharacteristics":
        ('PicamValueType_Enumeration', 'PicamConstraintType_None', 58),
    "PicamParameter_NormalizeOrientation":
        ('PicamValueType_Boolean', 'PicamConstraintType_Collection', 39),
    "PicamParameter_Age": ('PicamValueType_FloatingPoint', 'PicamConstraintType_None', 135),
    "PicamParameter_SequentialGateStepIterations":
        ('PicamValueType_LargeInteger', 'PicamConstraintType_Range', 98),
    "PicamParameter_TriggerTermination":
        ('PicamValueType_Enumeration', 'PicamConstraintType_Collection', 81),
    "PicamParameter_ActiveRightMargin": ('PicamValueType_Integer', 'PicamConstraintType_Range', 5),
    "PicamParameter_GratingCoating":
        ('PicamValueType_Enumeration', 'PicamConstraintType_None', 143),
    "PicamParameter_EnableSensorWindowHeater":
        ('PicamValueType_Boolean', 'PicamConstraintType_Collection', 127),
    "PicamParameter_PhotonDetectionThreshold":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Range', 126),
    "PicamParameter_ActiveLeftMargin": ('PicamValueType_Integer', 'PicamConstraintType_Range', 3),
    "PicamParameter_InputTriggerStatus":
        ('PicamValueType_Enumeration', 'PicamConstraintType_None', 158),
    "PicamParameter_TriggerCoupling":
        ('PicamValueType_Enumeration', 'PicamConstraintType_Collection', 82),
    "PicamParameter_LaserOutputMode":
        ('PicamValueType_Enumeration', 'PicamConstraintType_Collection', 137),
    "PicamParameter_OutputSignal":
        ('PicamValueType_Enumeration', 'PicamConstraintType_Collection', 32),
    "PicamParameter_AuxOutput": ('PicamValueType_Pulse', 'PicamConstraintType_Pulse', 91),
    "PicamParameter_TimeStamps":
        ('PicamValueType_Enumeration', 'PicamConstraintType_Collection', 68),
    "PicamParameter_ActiveHeight": ('PicamValueType_Integer', 'PicamConstraintType_Range', 2),
    "PicamParameter_ModulationTracking":
        ('PicamValueType_Enumeration', 'PicamConstraintType_Collection', 121),
    "PicamParameter_PhosphorDecayDelay":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Range', 89),
    "PicamParameter_ModulationTrackingBitDepth":
        ('PicamValueType_Integer', 'PicamConstraintType_Collection', 122),
    "PicamParameter_GateTracking":
        ('PicamValueType_Enumeration', 'PicamConstraintType_Collection', 104),
    ...
    "PicamParameter_InclusionAngle":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_None', 147),
    "PicamParameter_ActiveShutter":
        ('PicamValueType_Enumeration', 'PicamConstraintType_Collection', 155),
    "PicamParameter_LightSource":
        ('PicamValueType_Enumeration', 'PicamConstraintType_Collection', 133),
    "PicamParameter_SyncMaster2Delay":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Range', 85),
    "PicamParameter_SequentialEndingModulationPhase":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Range', 115),
    "PicamParameter_CleanCycleCount": ('PicamValueType_Integer', 'PicamConstraintType_Range', 20),
    "PicamParameter_AdcAnalogGain":
        ('PicamValueType_Enumeration', 'PicamConstraintType_Collection', 35),
    "PicamParameter_SequentialStartingModulationPhase":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Range', 114),
    "PicamParameter_PixelWidth": ('PicamValueType_FloatingPoint', 'PicamConstraintType_None', 9),
    "PicamParameter_DisableCoolingFan":
        ('PicamValueType_Boolean', 'PicamConstraintType_Collection', 29),
    "PicamParameter_IntensifierOptions":
        ('PicamValueType_Enumeration', 'PicamConstraintType_None', 101),
    "PicamParameter_AdcQuality":
        ('PicamValueType_Enumeration', 'PicamConstraintType_Collection', 36),
    "PicamParameter_RepetitiveModulationPhase":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Range', 113),
    "PicamParameter_FrameSize": ('PicamValueType_Integer', 'PicamConstraintType_None', 42),
    "PicamParameter_InvertOutputSignal2":
        ('PicamValueType_Boolean', 'PicamConstraintType_Collection', 151),
    "PicamParameter_PhotonDetectionMode":
        ('PicamValueType_Enumeration', 'PicamConstraintType_Collection', 125),
    "PicamParameter_ModulationDuration":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Range', 118),
    "PicamParameter_IntensifierGain": ('PicamValueType_Integer', 'PicamConstraintType_Range', 88),
    "PicamParameter_BracketGating":
        ('PicamValueType_Boolean', 'PicamConstraintType_Collection', 100),
    "PicamParameter_GratingBlazingWavelength":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_None', 145),
    "PicamParameter_IntensifierDiameter":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_None', 110),
    "PicamParameter_TriggerThreshold":
        ('PicamValueType_FloatingPoint', 'PicamConstraintType_Range', 83),
    "PicamParameter_CenterWavelengthStatus":
        ('PicamValueType_Enumeration', 'PicamConstraintType_None', 149),
    "PicamParameter_SequentialEndingGate":
        ('PicamValueType_Pulse', 'PicamConstraintType_Pulse', 96)}
...
PicamGatingSpeed = {1: "PicamGatingSpeed_Fast", 2: "PicamGatingSpeed_Slow"}
