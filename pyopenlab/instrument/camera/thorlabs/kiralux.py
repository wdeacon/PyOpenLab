...
import threading
from pyopenlab.instrument.camera import Camera, CameraControlWidget
...
from pyopenlab.instrument.camera.thorlabs.thorlabs_tsi_sdk.tl_mono_to_color_processor import MonoToColorProcessorSDK
import numpy as np
