...
from .tl_color_enums import FILTER_TYPE
...
class ColorProcessorSDK(object):
    ...
    def __init__(self):
        ...
        if ColorProcessorSDK._is_sdk_open:
            self._disposed = True
            _logger.error(
                "Error: ColorProcessorSDK is already in use. Please dispose of the current instance "
        ...
        try:
            ...
            self._sdk.tl_color_transform_48_to_48.argtypes = [
                c_void_p,
                POINTER(c_ushort), c_int, c_ushort, c_ushort, c_ushort, c_ushort, c_ushort,
                c_ushort, c_int, c_int, c_int,
                POINTER(c_ushort), c_int, c_int]
            self._sdk.tl_color_transform_48_to_32.argtypes = [
                c_void_p,
                POINTER(c_ushort), c_int, c_ushort, c_ushort, c_ushort, c_ushort, c_ushort,
                c_ushort, c_int, c_int, c_int,
                POINTER(c_ubyte), c_int, c_int]
            self._sdk.tl_color_transform_48_to_24.argtypes = [
                c_void_p,
                POINTER(c_ushort), c_int, c_ushort, c_ushort, c_ushort, c_ushort, c_ushort,
                c_ushort, c_int, c_int, c_int,
                POINTER(c_ubyte), c_int, c_int]
    ...
    def dispose(self):
        ...
        try:
            ...
            if err != 0:
                raise TLColorError(
                    ColorProcessorSDK._create_c_failure_message(
    ...
    def create_color_processor(self, input_lut_size_bits, output_lut_size_bits):
        ...
        return ColorProcessor(self._sdk, input_lut_size_bits, output_lut_size_bits,
                              self._create_c_failure_message)
...
class ColorProcessor(object):
    ...
    def __init__(self, sdk, input_lut_size_bits, output_lut_size_bits, error_string_generator):
        try:
            ...
            self._color_processor = self._sdk.tl_color_create_color_processor(
                self._input_lut_size_bits, self._output_lut_size_bits)
            if self._color_processor == 0:
                raise TLColorError(
                    "tl_color_create_color_processor() returned a NULL color processor\n")
    ...
    def dispose(self):
        ...
        try:
            ...
            if err != 0:
                raise TLColorError(
                    self._create_c_failure_message("tl_color_destroy_color_processor", err))
            self._disposed = True
        except Exception as error:
...
#  getters will return a copy of lut. setters will copy values from the given lut to the shared lut.
    ...
    def enable_input_luts(self, blue_LUT_enable, green_LUT_enable, red_LUT_enable):
        ...
        try:
            ...
            if err:
                raise TLColorError(self._create_c_failure_message("tl_color_enable_input_LUTs",
                                                                  err))
        except Exception as error:
    ...
    def enable_output_luts(self, blue_LUT_enable, green_LUT_enable, red_LUT_enable):
        ...
        try:
            ...
            if err:
                raise TLColorError(
                    self._create_c_failure_message("tl_color_enable_output_luts", err))
        except Exception as error:
            _logger.error("Could not enable output luts. ")
            raise error

    def transform_48_to_48(self, input_buffer, input_buffer_format, blue_output_min_value,
                           blue_output_max_value, green_output_min_value, green_output_max_value,
                           red_output_min_value, red_output_max_value, output_blue_shift_distance,
                           output_green_shift_distance, output_red_shift_distance,
        ...
        try:
            ...
            err = self._sdk.tl_color_transform_48_to_48(
                self._color_processor, input_pointer, input_buffer_format_value,
                blue_output_min_value, blue_output_max_value, green_output_min_value,
                green_output_max_value, red_output_min_value, red_output_max_value,
                output_blue_shift_distance, output_green_shift_distance, output_red_shift_distance,
                output_pointer, output_buffer_format_value, number_of_bgr_tuples)
            if err:
                raise TLColorError(
                    self._create_c_failure_message("tl_color_transform_48_to_48", err))
            return output_buffer
        except Exception as error:
            _logger.error("Could not transform image (48 to 48). ")
            raise error

    def transform_48_to_32(self, input_buffer, input_buffer_format, blue_output_min_value,
                           blue_output_max_value, green_output_min_value, green_output_max_value,
                           red_output_min_value, red_output_max_value, output_blue_shift_distance,
                           output_green_shift_distance, output_red_shift_distance,
                           output_buffer_format, number_of_bgr_tuples):
        ...
        try:
            ...
            output_buffer = np.empty(shape=(int(input_buffer.size + (input_buffer.size / 4)),),
                                     dtype=np.ubyte)
            output_buffer_pointer = output_buffer.ctypes.data_as(POINTER(c_ubyte))

            err = self._sdk.tl_color_transform_48_to_32(
                self._color_processor, input_buffer_pointer, input_buffer_format_value,
                blue_output_min_value, blue_output_max_value, green_output_min_value,
                green_output_max_value, red_output_min_value, red_output_max_value,
                output_red_shift_distance, output_green_shift_distance, output_blue_shift_distance,
                output_buffer_pointer, output_buffer_format_value, number_of_bgr_tuples)
            if err:
                raise TLColorError(
                    self._create_c_failure_message("tl_color_transform_48_to_32", err))
            return output_buffer
        except Exception as error:
            _logger.error("Could not transform image (48 to 32). ")
            raise error

    def transform_48_to_24(self, input_buffer, input_buffer_format, blue_output_min_value,
                           blue_output_max_value, green_output_min_value, green_output_max_value,
                           red_output_min_value, red_output_max_value, output_blue_shift_distance,
                           output_green_shift_distance, output_red_shift_distance,
                           output_buffer_format, number_of_bgr_tuples):
        ...
        try:
            ...
            err = self._sdk.tl_color_transform_48_to_24(
                self._color_processor, input_buffer_pointer, input_buffer_format_value,
                blue_output_min_value, blue_output_max_value, green_output_min_value,
                green_output_max_value, red_output_min_value, red_output_max_value,
                output_red_shift_distance, output_green_shift_distance, output_blue_shift_distance,
            ...
            if err:
                raise TLColorError(
                    self._create_c_failure_message("tl_color_transform_48_to_24", err))
            return output_buffer
        except Exception as error:
...
class Demosaicker(object):
    ...
    def __init__(self):
        ...
        if Demosaicker._is_sdk_open:
            _logger.error(
                "Error: Demosaicker is already in use. Please dispose of the current instance before "
        ...
        try:
            ...
            if err != 0:
                raise TLColorError("tl_demosaic_module_initialize failed with error code " +
                                   str(err) + "\n")
            Demosaicker._is_sdk_open = True
            self._disposed = False
            """ set C function argument types """

            self._sdk.tl_demosaic_transform_16_to_48.argtypes = [
    ...
    def dispose(self):
        ...
        try:
            ...
            if err != 0:
                raise TLColorError("tl_demosaic_module_terminate failed with error code " +
                                   str(err) + "\n")
    ...
    def transform_16_to_48(self, width, height, x_origin, y_origin, color_phase,
                           output_color_format, color_filter_type, bit_depth, input_buffer):
        ...
        try:
            ...
            err = self._sdk.tl_demosaic_transform_16_to_48(
                width, height, x_origin, y_origin, color_phase_value, output_color_format_value,
                color_filter_type_value, bit_depth, input_buffer_pointer, output_buffer_pointer)
            if err:
