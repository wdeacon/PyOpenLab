...
class CrossHair(pg.GraphicsObject):
    ...
    def boundingRect(self):
        return QtCore.QRectF(-self.crosshair_size, -self.crosshair_size, 2 * self.crosshair_size,
                             2 * self.crosshair_size)
...
class XYZPositionWidget(QWidget):
    ...
    def __init__(self, xrange_nm, yrange_nm, zrange_nm, show_xy_pos=True, show_z_pos=True):
