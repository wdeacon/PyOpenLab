...
def my_curve_fit(func, xdata, ydata,
                 *initial_parameters):  # the * makes it possible to assign any number of parameters
    ...
    yfit1 = func(xdata,
                 *calc_params)  # the * forces python to treat this list as seperate variables !
...
def my_bounded_curve_fit(func, xdata, ydata, init_params, bounds):
    ...
    # for param in initial_parameters:
    #     init_params=np.append(init_params,param)
    params1 = curve_fit(func, xdata=xdata, ydata=ydata, p0=init_params, bounds=bounds,
                        maxfev=10000)  #maxfev=10000
