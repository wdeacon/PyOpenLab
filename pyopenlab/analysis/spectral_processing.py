                ...
                Data = (old_div(
                    (Data -
                     (h5object.attrs['background_constant'] +
                      h5object.attrs['background_gradient'] * h5object.attrs['integration_time'])),
                    (old_div(
                        (h5object.attrs['reference'] -
                         (h5object.attrs['background_constant'] +
                          h5object.attrs['background_gradient'] * h5object.attrs['reference_int']))
        ...
        if 'background' in list(h5object.attrs.keys()):
            ...
            if 'reference' in list(h5object.attrs.keys()):
                if len(Data) == len(np.array(h5object.attrs['reference'])):
                    Data = old_div(Data, (np.array(h5object.attrs['reference']) -
