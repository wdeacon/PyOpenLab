...
def get_spectrum(pacton,
    ...
    if debug > 0:
        print("Starting wavelength map...")
    wavelengths = [mapper(center_wavelength, i) for i in pixel_indices]
    if laser_wavelength is not None:
        raman_shifts = [
            nm_to_raman_shift(laser_wavelength=laser_wavelength, wavelength=wl)
...
if __name__ == "__main__":
    file = initialize_datafile(
        'C:\\Users\\Hera\\Desktop\\New folder\\20190315\\spectra\\ECDMCCenter840_vc1percent.hdf5')
