...
def extractor(filepath, folderpath):
    ...
    assert unix_timestamp(data[0][0]) < unix_timestamp(
        data[1][0]), "timestamp of first element is less than timestamp of second element"
    return data
...
def mapped_extractor(filepath, folderpath, mapper):
    ...
    mapped_data = [(dt, array_mapper(center_wl, pixel_offsets, mapper), intensity)
...
if __name__ == "__main__":
    print("start")
    from pyopenlab.experiment.fiber_raman.spectrum_aligner_ir import grating_1200gmm as make_mapper
